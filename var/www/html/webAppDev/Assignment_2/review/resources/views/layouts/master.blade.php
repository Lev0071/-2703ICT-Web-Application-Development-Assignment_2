    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <a class="navbar-brand" href="{{ url('product') }}"><img class="logo" src="{{asset('images/720887.webp')}}" alt="" width="50" height="50">Gadget Reviews</a>
                    ...
                    <form class="d-flex">
                    <a class="nav-link" href="{{ URL::asset('/assets/pdf/Assignment_2_Report.pdf', 'Link') }}">Documentation</a>
                    <a class="nav-link" href="{{ url('product/users') }}">Users</a>
                    @auth
                    ...
                    @auth
                            ...
                            <p class="nav-link" style="color:white;background-color:red;">Welcome {{Auth::user()->name}}! </p>


                    @else
                        <div class="navButton">
                            <a href="{{ route('login') }}" class="btn btn-outline-success" role="button">Log in</a>  
                            <a href="{{ route('register') }}" class="btn btn-outline-success" role="button">Register</a>  
                        </div>
                    @endauth 
